...
namespace MinecraftManager
{
    public partial class LogDisplay : Form
    {
        ...
        public LogDisplay(string pathName,params string[] keywords)
            : this()
        {
            _pathName = pathName;
            _keywords = keywords;
        ...
        string ReadFile(string path)
        {
            ...
            using (var f = File.Open(_pathName, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                int readLength;
                do
                {
    ...
    public IEnumerable<Tuple<int,string,Color>> FindItemsToColor(string line)
{
    ...
    private Tuple<int,string> GetKeyWord(string remainder)
    {
...
#warning Not implemented
    ...
    private void openToolStripMenuItem_Click(object sender, EventArgs e)
    {
        ...
        {
            ofd.FileName = _pathName;
            if (ofd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                _pathName = ofd.FileName;
                ReadFile();
            }
        }
    }
